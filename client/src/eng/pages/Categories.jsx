...
const Categories = () => {
        ...
        return (
            <div className="w-full flex flex-col sm:flex-row justify-between items-center gap-4 mt-4 py-3 px-4 bg-white rounded-lg shadow-sm border border-gray-200">
                <div className="text-sm text-gray-600">
                    Showing <span className="font-semibold text-blue-600">{categories.length}</span> of{' '}
                    <span className="font-semibold text-blue-600">{pagination.total}</span> categories
                </div>
    ...
    return (
        <div className="min-h-screen w-full bg-gradient-to-br from-blue-50 to-sky-50">
            {/* Header */}
                                                            ...
                                                            <div className="flex items-center gap-3 flex-1">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <div className="flex items-center gap-3 mt-1 text-xs text-gray-500">
                                                                        <span>Qty: {product.qty} {product.unit}</span>
                                                                        <span>•</span>
            ...
            <AnimatePresence>
                ...
                {isAddProductModalOpen && selectedCategory && (
                    <AddProductsModal
                        ...
                        categoryId={selectedCategory._id} // Make sure this is _id, not id
