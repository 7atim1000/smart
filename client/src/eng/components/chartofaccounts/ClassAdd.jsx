...
import { FaPlus, FaEdit, FaSitemap } from "react-icons/fa";

const ClassAdd = ({ setIsClassModalOpen, chartId, levelId, fetchClasses, mode = 'add', classData = null, onSubmit }) => {
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-blue-100 mt-0.5">
                                        {mode === 'edit' ? 'Update class information' : 'Create a new class in this level'}
                                    </p>
                                </div>
                            </div>
                            <button
                    ...
                    <form onSubmit={onSubmitHandler} className="p-6">
                        ...
                        <div className="mb-6">
                            ...
                            {!formErrors.code && (
                                <p className="mt-1 text-xs text-gray-500">
                                    Code must be unique within this level
                                </p>
                            )}
                        </div>
                        ...
                        <div className="mb-6 p-4 bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg border border-blue-300 shadow-inner">
                            ...
                            <p className="text-xs text-blue-700">
                                Classes are the second level under a level (e.g., Current Assets, Fixed Assets).
                            </p>
                        </div>
                            ...
                            >
                                {isLoading ? (
                                    ...
                                    <>
                                        ...
                                        <span>{mode === 'edit' ? 'Update Class' : 'Add Class'}</span>
                                    </>
                                )}
                            </button>
                        </div>
