...
const PrintQuotation = ({ buyInfo, setShowQuotation }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50 p-4" dir="ltr">
            <motion.div
            ...
            >
                ...
                <div className="bg-gradient-to-r from-blue-600 to-blue-700 p-4 text-white flex justify-between items-center">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-xl font-bold">Buy Quotation</h2>
                            <p className="text-blue-100 text-sm">Quotation #{buyInfo?.invoiceNumber}</p>
                        </div>
                    </div>
                    <button
                        onClick={handleClose}
                ...
                <div className="flex-1 overflow-y-auto p-6 bg-gray-50">
                    ...
                    >
                        ...
                        <div className="text-center mb-8 border-b-2 border-blue-200 pb-6">
                            <h1 className="text-3xl font-bold text-blue-800 mb-2">Buy QUOTATION</h1>
                        ...
                        <div className="grid grid-cols-2 gap-6 mb-8 text-sm">
                            ...
                            <div>
                                ...
                                <p className="font-semibold text-gray-800">{buyInfo?.supplierName || buyInfo?.supplier?.name || 'Walk-in Supplier'}</p>
                            </div>
                        </div>
                                        ...
                                        {buyInfo.items.map((item, index) => (
                                            <tr key={index} className="border-b border-gray-200 hover:bg-gray-50">
                                                ...
                                                <td className="p-3 text-right text-sm font-medium">
                                                    {(item.pricePerQuantity || item.price) * item.quantity} {buyInfo.bills?.currency}
                                                </td>
                                            </tr>
                                        ))}
                                    </tbody>
