            ...
            >
                ...
                <div className='p-6 border-b border-blue-100'>
                    ...
                    <div className="mt-3 text-xs text-blue-600 bg-blue-50 px-3 py-2 rounded-lg inline-block">
                        Showing only suppliers (payables accounts)
                    </div>
                </div>
                ...
                {loading && (
                    <div className="flex flex-col items-center justify-center py-12">
                        ...
                        <p className="text-sm text-gray-500 mt-2">Please wait while we fetch the suppliers list</p>
                    </div>
                )}
                    ...
                    {!loading && list.length === 0 ? (
                        <div className="flex flex-col items-center justify-center py-16 px-4 text-center">
                            ...
                            <h3 className="text-xl font-semibold text-gray-700 mb-2">
                                {debouncedSearch ? 'No Customers Found' : 'No Suppliers Available'}
                            </h3>
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    <div className="flex items-center gap-2 mt-1">
                                                        <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                                                            ...
                                                            {Number(supplier.balance) === 0 ? 'Balance Clear' : 
                                                             Number(supplier.balance) > 0 ? 'Has Balance' : 'In Credit'}
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
