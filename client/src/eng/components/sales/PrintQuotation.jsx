                ...
                <div className="bg-gradient-to-r from-blue-600 to-blue-700 p-4 text-white flex justify-between items-center">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-blue-100 text-sm">Quotation #{saleInfo?.invoiceNumber}</p>
                        </div>
                    </div>
                    <button
                        onClick={handleClose}
                ...
                <div className="flex-1 overflow-y-auto p-6 bg-gray-50">
                    ...
                    >
                        ...
                        <div className="text-center mb-8 border-b-2 border-blue-200 pb-6">
                            <h1 className="text-3xl font-bold text-blue-800 mb-2">QUOTATION</h1>
                        ...
                        <div className="grid grid-cols-2 gap-6 mb-8 text-sm">
                            ...
                            <div>
                                ...
                                <p className="font-semibold text-gray-800">{saleInfo?.customerName || saleInfo?.customer?.name || 'Walk-in Customer'}</p>
                            </div>
                        </div>
