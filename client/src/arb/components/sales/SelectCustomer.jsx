...
const SelectCustomer = ({ setIsSelectCustomerModalOpen }) => {
    ...
    // Get Arabic balance status
    const getBalanceStatus = (balance) => {
        if (Number(balance) === 0) return 'الرصيد صافي';
        if (Number(balance) > 0) return 'عليه رصيد';
        return 'له رصيد';
    };
            ...
            >
                ...
                <div className="flex items-center justify-between p-6 bg-gradient-to-r from-blue-600 to-blue-700 rounded-t-2xl">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className='text-white text-lg md:text-xl font-bold'>اختيار عميل</h2>
                            <p className='text-blue-100 text-sm'>اختر عميلاً لعملية البيع</p>
                        </div>
                    </div>
                    <button
                ...
                {loading && (
                    <div className="flex flex-col items-center justify-center py-12">
                        ...
                        <p className="text-gray-600 font-medium">جاري تحميل العملاء...</p>
                        <p className="text-sm text-gray-500 mt-2">يرجى الانتظار أثناء تحميل قائمة العملاء</p>
                    </div>
                )}
                    ...
                    {!loading && list.length === 0 ? (
                        <div className="flex flex-col items-center justify-center py-16 px-4 text-center">
                            ...
                            <h3 className="text-xl font-semibold text-gray-700 mb-2">
                                {debouncedSearch ? 'لا توجد نتائج للبحث' : 'لا يوجد عملاء'}
                            </h3>
                            <p className="text-gray-500 max-w-md">
                                {debouncedSearch
                                    ? `لا يوجد عملاء يطابقون "${debouncedSearch}"`
                                    : 'قائمة العملاء فارغة. ابدأ بإضافة عملاء جدد!'}
                            </p>
                        </div>
                    ) : (
                ...
                <div className='p-4 border-t border-blue-100 bg-gradient-to-r from-blue-50 to-white rounded-b-2xl'>
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
                        <div className="flex items-center gap-2 text-sm text-gray-600">
                            ...
                            <span>عرض <span className="font-semibold text-blue-700">{list.length}</span> عميل</span>
                        </div>
                        <div className="flex items-center gap-4">
                            ...
                            <div className="text-xs text-gray-500">
                                اضغط على بطاقة العميل للاختيار
                            </div>
                        </div>
                    </div>
                </div>
