...
const Contacts = () => {
    ...
    const fetchContacts = async (page = pagination.currentPage) => {
        ...
        try {
            ...
            toast.error('خطأ في تحميل جهات الاتصال');
        } finally {
            setLoading(false);
        }
    };
    ...
    const handleViewContact = (contact) => {
        navigate(`/ar/contactdetails/${contact._id}`, { state: { contact } });
    };
    ...
    const handleDeleteContact = async (id, e) => {
        ...
        if (window.confirm('هل أنت متأكد من حذف جهة الاتصال هذه؟')) {
            try {
                ...
                toast.error(error.response?.data?.message || 'خطأ في حذف جهة الاتصال');
            }
        }
    };
        ...
        return (
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mt-4 py-3 px-4 bg-white rounded-lg shadow-sm border border-gray-200">
                <div className="text-sm text-gray-600">
                    عرض <span className="font-semibold text-blue-600">{contacts.length}</span> من{' '}
                    <span className="font-semibold text-blue-600">{pagination.total}</span> جهة اتصال
                </div>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500">
                                إدارة العملاء، الموردين، والشركاء
                            </p>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    ...
                    >
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-sm text-gray-500">جميع جهات الاتصال</p>
                    ...
                    >
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-sm text-gray-500">الموردين</p>
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            placeholder="ابحث عن جهات اتصال بالاسم، البريد الإلكتروني، أو رقم الهاتف..."
                    ...
                    <div className={`${showFilters ? 'flex' : 'hidden sm:flex'} flex-col sm:flex-row gap-3`}>
                        <select
                            ...
                            className="flex-1 px-3 py-2 border border-gray-200 rounded-lg
                                     ...
                                     bg-white text-sm"
                        >
                            <option value="">جميع حالات القبض</option>
                            <option value="true">قبض فقط</option>
                            <option value="false">غير قبض</option>
                        </select>
                        ...
                        >
                            ...
                            <option value="true">دفع فقط</option>
                            <option value="false">غير دفع</option>
                        </select>
                        ...
                        >
                            ...
                            <option value="name">الاسم: من أ إلى ي</option>
                            <option value="-name">الاسم: من ي إلى أ</option>
                            <option value="email">البريد الإلكتروني: من أ إلى ي</option>
                            <option value="-email">البريد الإلكتروني: من ي إلى أ</option>
                        </select>
            ...
            <div className="px-4 sm:px-6 pb-6">
                {loading ? (
                    ...
                    <div className="text-center py-12 bg-white rounded-xl shadow-sm">
                        ...
                        <h3 className="text-xl font-semibold text-gray-700 mb-2">لا توجد جهات اتصال</h3>
                                        ...
                                        <div className="mt-4 pt-3 border-t border-gray-100">
                                            <div className="flex justify-between items-center">
                                                ...
                                                <span className={`font-semibold ${
                                                    ...
                                                    {contact.balance?.toFixed(2)} درهم
                                                </span>
                                            </div>
                                        </div>
                                    </div>
