...
const JournalsNameController = __importStar(require("./journalsName.controller"));
const authentication_1 = require("../../middleware/authentication");
const router = express_1.default.Router();
// BALANCE
router.get('/:id/balance', JournalsNameController.getJournalNameBalanceController);
// GET routes
router.get('/', authentication_1.protectRoute, JournalsNameController.getJournalsNameController);
...
// POST routes
router.post('/', authentication_1.protectRoute, JournalsNameController.addJournalsNameController);
// PUT routes
