...
import { UpdateJournalRequest } from './journals.interface';
...
// ============================================
export const updateJournalController = async (req: Request, res: Response): Promise<void> => {
    try {
...
export const addJournalController = async (req: Request, res: Response): Promise<void> => {
    try {
        const { 
            status,
            reference,
...
// ============================================
export const getJournalsController = async (req: Request, res: Response): Promise<void> => {
    try {
        // Query Parameters
        ...
        const filter = {
            ...
            ...(currency && { currency: currency as string }), // NEW
...
// ============================================
export const getJournalByIdController = async (req: Request, res: Response): Promise<void> => {
    try {
        const id = getStringParam(req.params.id);
...
// ============================================
export const getJournalsByJournalNameController = async (req: Request, res: Response): Promise<void> => {
    try {
        ...
        if (page || limit) {
            ...
            const result = await JournalsService.searchJournalsByNameService(
        ...
        const journals = await JournalsService.getJournalsByJournalNameService(searchTerm as string);
...
// ============================================
export const getJournalByCodeController = async (req: Request, res: Response): Promise<void> => {
    try {
...
// ============================================
export const getJournalsByAccountController = async (req: Request, res: Response): Promise<void> => {
    try {
        ...
        const journals = await JournalsService.getJournalsByAccountService(
            accChart as string,
            accLevel as string,
            accGroup as string,
            accClass as string
...
// ============================================
export const getJournalsByPartnerController = async (req: Request, res: Response): Promise<void> => {
    try {
...
// ============================================
export const closeJournalController = async (req: Request, res: Response): Promise<void> => {
    try {
        const id = getStringParam(req.params.id);
...
// ============================================
export const deleteJournalController = async (req: Request, res: Response): Promise<void> => {
    try {
        const id = getStringParam(req.params.id);
...
export const getBalanceSheetController = async (req: Request, res: Response): Promise<void> => {
    try {
        ...
        const groupByLevel = (accounts: any[]): any => {
    const grouped: any = {};
...
export const getJournalFiltersController = async (req: Request, res: Response): Promise<void> => {
    try {
